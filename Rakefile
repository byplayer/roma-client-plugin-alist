...
SPEC = Gem::Specification.new do |s|
  s.authors = ["Muga Nishizawa", "Junji Torii", "Yukio Goto"]
  s.name = "roma-client-plugin-alist"
  s.version = CURRENT_VERSION
  s.summary = "alist plugin for ROMA client"
  s.description = "alist plugin for ROMA client"
...
Rake::RDocTask.new("doc") { |rdoc|
  rdoc.rdoc_dir = 'doc'
  rdoc.title = "alist plugin for ROMA client"
